        ...
        $collections = get_posts([
            ...
            'tax_query' => [
                [
                    ...
                    'terms' => 'programmes-automne-hiver', // replace with your category slug
                ],
            ],
        ]); 
        ?>
        ...
        <?php else: ?>
            <div
                ...
                <div class="p-8 text-center">
                    ...
                    <h2 class="text-2xl mb-4 uppercase font-[Oswald] tracking-widest">Aucun programme disponible
                        actuellement
                    </h2>
                    <p class="text-white/80 mb-6 max-w-2xl mx-auto font-[Inter] text-lg sm:text-xl ">Aucun programme n’est offert pour le moment. Revenez bientôt pour découvrir nos prochaines
