            ...
            <div class="w-full xl:max-w-fit">
                ...
                <div class="space-y-6 md:space-y-3">
                    <div class="flex items-center gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        </svg><span class="truncate font-[Inter] text-xl md:text-sm tracking-widest text-gray-300">(819)
                            775-7836</span></div>
                    <div class="flex overflow-hidden items-center gap-3">
                        ...
                        <span class="truncate font-[Inter] text-xl md:text-sm tracking-widest text-gray-300 min-w-0">
