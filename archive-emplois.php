        ...
        <?php else: ?>
            <div
                ...
                <div class="p-8 text-center">
                    ...
                    <h2 class="text-2xl mb-4 uppercase font-[Oswald] tracking-widest">Aucun poste disponible actuellement
                    </h2>
                    <p class="text-white/80 mb-6 max-w-2xl mx-auto font-[Inter] text-lg sm:text-xl ">Nous n'avons pas
